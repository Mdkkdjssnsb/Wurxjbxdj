...
app.listen(port, () => {
  console.log(gradient.rainbow(`[ SERVER ] localhost:${port} https://${process.env.REPL_ID}.sisko.replit.dev/`));
...
const { botName, adminName } = require('./script/info.js');
          ...
          if (event.body && !command && event.body?.toLowerCase().startsWith(prefix.toLowerCase())) {
            api.sendMessage(`❗𝖳𝗁𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝗒𝗈𝗎 𝖺𝗋𝖾 𝗎𝗌𝗂𝗇𝗀 𝖽𝗈𝖾𝗌 𝗇𝗈𝗍 𝖾𝗑𝗂𝗌𝗍, 𝗉𝗅𝖾𝗌𝗌𝖾 𝗍𝗒𝗉𝖾 ${prefix}𝗁𝖾𝗅𝗉 𝗍𝗈 𝗌𝖾𝖾 𝖺𝗅𝗅 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌.`, event.threadID, event.messageID);
            return;
          }
if (event.body && !command && event.body?.toLowerCase().startsWith(prefix.toLowerCase())) {
    api.sendMessage(`❗𝖳𝗁𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝗒𝗈𝗎 𝖺𝗋𝖾 𝗎𝗌𝗂𝗇𝗀 𝖽𝗈𝖾𝗌 𝗇𝗈𝗍 𝖾𝗑𝗂𝗌𝗍, 𝗉𝗅𝖾𝗌𝗌𝖾 𝗍𝗒𝗉𝖾 ${prefix}𝗁𝖾𝗅𝗉 𝗍𝗈 𝗌𝖾𝖾 𝖺𝗅𝗅 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌.`, event.threadID, event.messageID);
...
if (event.body && command && prefix && event.body?.toLowerCase().startsWith(prefix.toLowerCase()) && !aliases(command)?.name) {
            api.sendMessage(`❗𝖢𝗈𝗆𝗆𝖺𝗇𝖽 𝗒𝗈𝗎 𝖺𝗋𝖾 𝗎𝗌𝗂𝗇𝗀 "${command}" 𝖽𝗈𝖾𝗌 𝗇𝗈𝗍 𝖾𝗑𝗂𝗌𝗍, 𝗉𝗅𝖾𝗌𝗌𝖾 𝗍𝗒𝗉𝖾 ${prefix}𝗁𝖾𝗅𝗉 𝗍𝗈 𝗌𝖾𝖾 𝖺𝗅𝗅 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌.`, event.threadID, event.messageID);
            return;
          }
          for (const {
              handleEvent,
...
async function addThisUser(userid, enableCommands, state, prefix, botName,adminName, admin, blacklist) {
  ...
  config.push({
    userid,
    prefix: prefix || ".",
    botName: botName || "🤖 𝗢𝗿𝗼𝗰𝗵𝗶 - 𝗔𝗨𝗧𝗢𝗕𝗢𝗧",
    adminName: adminName || "Orochi Dev",
