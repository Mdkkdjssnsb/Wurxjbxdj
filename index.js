...
app.listen(port, () => {
  ...
  console.log(gradient.rainbow(`Server is running on port ${port}`));
});
...
if (event.body && command && prefix && event.body?.toLowerCase().startsWith(prefix.toLowerCase()) && !aliases(command)?.name) {
            api.sendMessage(`𝖳𝗁𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 ${command} 𝖽𝗈𝖾𝗌 𝗇𝗈𝗍 𝖾𝗑𝗂𝗌𝗍, 𝗉𝗅𝖾𝗌𝗌𝖾 𝗍𝗒𝗉𝖾 ${prefix}𝗁𝖾𝗅𝗉 𝗍𝗈 𝗌𝖾𝖾 𝖺𝗅𝗅 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌.`, event.threadID, event.messageID);
            return;
          }
          for (const {
              handleEvent,
